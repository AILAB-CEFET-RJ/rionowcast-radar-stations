...
"""Gera targets e mascaras AlertaRio alinhados aos timestamps do radar.

Exemplo:
    nowcasting-build-alertario-targets \\
        --alertario-root data/datasets/raw/alertario/pluviometricos_parquet \\
        --mapping data/mapeamento_pixel_estacao_alertario.csv \\
        --radar-root data/datasets/radar_sumare_2012_2024_15min_128_por_ano \\
        --year-start 2012 --year-end 2024 --height 128 --width 128
"""
